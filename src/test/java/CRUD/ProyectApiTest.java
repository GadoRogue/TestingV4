...
public class ProyectApiTest {
    @Test
    @DisplayName("Verify the CRUD proyect")

    public void CreateUpdateDeleteProyect (){
        ...
        Response response =given()
                .auth()
                .preemptive()
                .basic("Gadiel.Bacarreza@2023.com","12345")
                .body(body.toString())
                .log().all()
                .when()
        ...
        response=given()
                ...
                .log().all()
                .when()
                .get("https://todo.ly/api/user/"+idUser+".json");
        ...
        response =given()
                ...
                .log().all()
                .when()
                .put("https://todo.ly/api/user/"+idUser+".json");
        ...
        response=given()
                ...
                .log().all()
                .when()
                .delete("https://todo.ly/api/user/"+idUser+".json");
